...
- If a milestone introduces a new artifact or script, add an eval gate or a small unit test and log it in `orchestration/vscode_orchestration_gpt5/project_modifications_tasks/tasks_032026_1.md` (`temp_Feb2026_1.md` and `temp_12.md` are legacy archives).
...
|---|---|---|---|---|---|
| M0 — Baseline snapshot | Ensure “what exists” is documented | Prevents reviewers from assuming missing modules/features | `py -3 run_eval.py` | Updated evaluation artifacts under `LongTermStore/` and/or `ActiveSpace/` depending on current harness behavior | `README.md`, `DESIGN_GOALS.md`, `orchestration/vscode_orchestration_gpt5/project_modifications_tasks/tasks_032026_1.md`, `run_eval.py` |
...
- `orchestration/vscode_orchestration_gpt5/project_modifications_tasks/tasks_032026_1.md` (current monthly log; `temp_Feb2026_1.md` and `temp_12.md` are legacy archives)
...
- If a prior snapshot file (e.g., `temp_23_v2.md`) claims modules that do not exist in this repo, treat it as *non-authoritative* and prefer `orchestration/vscode_orchestration_gpt5/project_modifications_tasks/tasks_032026_1.md` + this roadmap (`temp_Feb2026_1.md` and `temp_12.md` are legacy archives).
